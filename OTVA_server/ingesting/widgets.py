# START ColumnCheckboxSelectMultiple: CheckboxSelectMultiple that renders in columns - snippet #2236
import math
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        for column in columns:
            if self.css_class:
                ...
                output.append(u'<ul style="display: block; float: left; margin-left: 0; padding-left: 0;" >')
            ...
            for i, (option_value, option_label) in column:
                ...
                output.append(u'<li style="list-style-type:none"><label%s>%s %s</label></li>' % (
...
# END ColumnCheckboxSelectMultiple: CheckboxSelectMultiple that renders in columns - snippet #2236